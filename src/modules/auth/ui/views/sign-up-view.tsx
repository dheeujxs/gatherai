     ...
     <form className='p-6 md:p-8' onSubmit={form.handleSubmit(onSubmit)}>
        ...
        {!!error && (
            <Alert className='bg-destructive/10 border-none'>
                <OctagonAlertIcon  className='h-4 2-4 !text-destructive'/>
...
Sign In
        ...
        <div className='text-center text-sm'>
            Already have an account?{" "} <Link className='underline underline-offset-4' href='/sign-in'>
            Sign In</Link>
          ...
          <div className="bg-radial from-sidebar-accent to-sidebar relative hidden md:flex flex-col gap-y-4 items-center justify-center">
            ...
            <p className="text-2xl font-semibold text-white">Gather.AI</p>
          </div>
        </CardContent>
      </Card>
      <div className='text-muted-foreground *:[a]:hover:text-primary text-center text-sm text-balance *:[a]:underline *:[a]:underline-offset-4' >
        By Click continue, you agree to our <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>
